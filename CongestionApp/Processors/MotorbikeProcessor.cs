...
{
    public class MotorbikeProcessor : BaseVehicleProcessor
    {
        public override void CalculateVehicleCharge(Vehicle item)
        {
            ...
            Console.WriteLine($"Charge for {calculatedCharge.AmHours.Hours}h {calculatedCharge.AmHours.Minutes}m (PM rate): {chargeForPm.ToString("C", new CultureInfo("en-GB"))}");
